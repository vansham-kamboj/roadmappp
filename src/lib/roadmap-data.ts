...
export const ROADMAP_DATA: Field[] = [
    ...
    },
    {
      ...
      name: 'Deployment',
      icon: 'devops',
      description: 'Deploy, manage, and monitor web applications, from simple static sites to complex cloud-native systems.',
      details: 'This roadmap covers the essential skills for deploying applications, including version control, web hosting, databases, CI/CD, containerization, and cloud platforms. Students will learn to move an application from a development environment to production.',
      relatedFields: ['devops-engineering', 'cloud-engineering'],
      roadmap: [
        { title: 'Understand Deployment Basics', description: 'Learn about environments, domains, hosting, and DNS.' },
        { title: 'Version Control', description: 'Learn Git and GitHub for source code management.' },
        { title: 'Web Hosting Fundamentals', description: 'Explore different hosting types and platforms like Vercel and Heroku.' },
        { title: 'Backend Deployment Basics', description: 'Understand web servers and deploy simple backend apps.' },
        { title: 'Databases and Environment Variables', description: 'Learn to use managed databases and handle secrets.' },
        { title: 'Domain Names and SSL', description: 'Configure domains and set up HTTPS for secure connections.' },
        { title: 'Continuous Integration & Deployment (CI/CD)', description: 'Automate testing and deployment pipelines with GitHub Actions.' },
        { title: 'Containerization and Orchestration', description: 'Study Docker to containerize apps, with an introduction to Kubernetes.' },
        { title: 'Cloud Provider Deployment', description: 'Dive deep into deploying on AWS, Azure, or GCP.' },
        { title: 'Monitoring and Logging', description: 'Learn to use tools like Prometheus, Grafana, and Cloudwatch.' },
      ],
    },
    {
